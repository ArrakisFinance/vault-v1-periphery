...
const swapTokenData = async (
  ...
  try {
    ...
    console.log("swap - apiResponse.tx.to: ", apiResponse.tx.to);
    console.log("swap - apiResponse.tx.data: ", apiResponse.tx.data);
    return {
...
const quote1Inch = async (
  ...
  try {
    ...
    console.log(
      "quote - apiResponse.toTokenAmount: ",
      apiResponse.toTokenAmount
    );
